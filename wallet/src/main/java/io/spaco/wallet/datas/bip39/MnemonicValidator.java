...
import io.spaco.wallet.datas.bip39.Validation.InvalidChecksumException;
import io.spaco.wallet.datas.bip39.Validation.InvalidWordCountException;
import io.spaco.wallet.datas.bip39.Validation.UnexpectedWhiteSpaceException;
import io.spaco.wallet.datas.bip39.Validation.WordNotFoundException;

import static io.spaco.wallet.datas.bip39.MnemonicGenerator.firstByteOfSha256;
import static io.spaco.wallet.datas.bip39.Normalization.normalizeNFKD;
